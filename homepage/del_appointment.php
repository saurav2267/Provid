...
<body>
  ...
  <!-- End Header -->
    ...
    <div class="services container">
      <div class="service-top">
        <h1 class="section-title"><b><span>A</span>ppointment<span> C</span>ancellation</b></h1>
      </div>
	  <table>
  ...
  <tr>
	<th>Appointment Number <span style="color:red";>*</span></th><td><input type="number" name="ap_id" required></td>
  </tr>
  <tr>
	<td colspan="2"><center><input style="background-color:crimson;color:white; padding:10px;" type="submit" value="Delete Appointment"></center></td>
  </tr>
  </form>
  </table>
  <br><br><br><br>
